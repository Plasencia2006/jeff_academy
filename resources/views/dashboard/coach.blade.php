...
<div x-data="{ 
    ...
    x-init="
        ...
        if (['asistencia', 'estadisticas', 'horarios', 'observaciones', 'gestion-entrenamientos', 'jugadores', 'anuncios', 'perfil', 'comunicados'].includes(hash)) {
            currentSection = hash;
        }
        ...
        window.addEventListener('hashchange', () => {
            ...
            if (['asistencia', 'estadisticas', 'horarios', 'observaciones', 'gestion-entrenamientos', 'jugadores', 'anuncios', 'perfil', 'comunicados'].includes(newHash)) {
