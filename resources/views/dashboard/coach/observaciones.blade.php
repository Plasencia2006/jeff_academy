    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">
                <i class="fas fa-clipboard-list text-purple-600 mr-2 sm:mr-3"></i>
            ...
            <div class="p-6">
                <form action="{{ route('coach.observaciones.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-center gap-6 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                class="px-8 py-2 text-sm bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
