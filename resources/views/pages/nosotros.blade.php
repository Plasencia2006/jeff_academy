...
<section class="nosotros-cta-top" style="background-image: url('{{ asset('img/hero-nos.png') }}');">
    <div class="cta-top-overlay"></div>
    <div class="cta-top-content">
        <h2 class="cta-top-title">¿QUIERES SER PARTE<br>DEL EQUIPO?</h2>
        <p class="cta-top-subtitle">
