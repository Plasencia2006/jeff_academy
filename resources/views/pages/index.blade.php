...
@section('content')
    ...
    <!-- ===================================
         INSTALACIONES
         =================================== -->
    <section id="instalaciones" class="gallery-section">
        <div class="container">
            <h2 class="section-titlei">Nuestras Instalaciones</h2>
            <p class="section-subtitlei">Espacios diseñados para potenciar el rendimiento de nuestros futbolistas</p>
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-item">
                    ...
                    <div class="gallery-overlay">
                        <h4>Campo Profesional</h4>
                        <p>Superficie de nivel competitivo, perfecta para entrenamientos y partidos oficiales.</p>
                    </div>
                </div>
                <!-- 3 -->
                <div class="gallery-item">
                    ...
                    <div class="gallery-overlay">
                        <h4>Entrenamiento Físico</h4>
                        <p>Área equipada para mejorar fuerza, resistencia y capacidad atlética.</p>
                    </div>
                </div>
                ...
                <div class="gallery-item">
                    ...
                    <div class="gallery-overlay">
                        <h4>Zona de Porteros</h4>
                        <p>Espacio exclusivo con materiales especializados para arqueros.</p>
                    </div>
                </div>
                ...
                <div class="gallery-item">
                    ...
                    <div class="gallery-overlay">
                        ...
                        <p>Uniformes modernos y exclusivos diseñados para nuestros jugadores.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="disciplinas" class="disciplinas-section">
        <div class="container">
            <h2 class="section-titles">Nuestras Disciplinas de Fútbol</h2>
            <p class="disciplinas-subtitles">
    ...
    <section class="testimonios-section" id="testimonios">
        <div class="container">
            ...
            <div class="testimonios-header">
                <span class="testimonios-badge">
                    <i class=""></i> TESTIMONIOS
                </span>
            ...
            <div class="carousel-wrapper">
                ...
                <div class="carousel-track" id="carouselTrack">
                    ...
                    <div class="testimonio-card">
                        <div class="testimonio-header">
                            <div class="avatar-wrapper">
                                <img src="{{ asset('img/perfiles/perfil 1.png') }}" alt="Diego Sánchez">
                    ...
                    <div class="testimonio-card">
                        <div class="testimonio-header">
                            <div class="avatar-wrapper">
                                <img src="{{ asset('/img/perfiles/perfil2.png') }}" alt="Carlos Rodríguez">
                                <div class="verified-badge">
                                    <i class="fas fa-check"></i>
                                </div>
                            </div>
