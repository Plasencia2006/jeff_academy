document.addEventListener("DOMContentLoaded", () => {
    ...
    function showQuickOptions() {
        ...
        const options = [
            ...
            { icon: "fa-clipboard-list", text: "Inscripciones", value: "inscripciones" },
    ...
    function getSmartReply(text) {
        ...
        if (msg.includes("horario") || msg.includes("hora")) {
            lastTopic = "horarios";
            return `<i class="fas fa-clock text-primary me-1"></i> <b>Horarios:</b><br>🕗 Lunes a sábado: <b>8:00 a.m. - 6:00 p.m.</b><br>Domingos: solo partidos y torneos ⚽🔥`;
        }

        if (msg.includes("precio") || msg.includes("plan") || msg.includes("costo")) {
            lastTopic = "precios";
            return `<i class="fas fa-sack-dollar text-success me-1"></i> <b>Planes y precios:</b><br>💰 <b>Mensual:</b> S/120<br>💪 <b>Trimestral:</b> S/320<br>🏆 <b>Anual:</b> S/1100 (incluye camiseta y torneo interno)`;
        }

        if (msg.includes("inscripción") || msg.includes("registrar")) {
            lastTopic = "inscripciones";
        ...
        if (msg.includes("ubicacion") || msg.includes("donde") || msg.includes("lugar")) {
            lastTopic = "ubicacion";
            return `<i class="fas fa-map-marker-alt text-danger me-1"></i> <b>Ubicación:</b><br>📍 Av. América Sur, Trujillo – Frente al Mall Aventura.<br>Contamos con <b>3 canchas de césped sintético</b> y estacionamiento. 🚗`;
        }

        if (msg.includes("contacto") || msg.includes("whatsapp") || msg.includes("telefono")) {
            lastTopic = "contacto";
            return `<i class="fas fa-phone text-success me-1"></i> <b>Contacto:</b><br>📞 <b>+51 999 999 999</b><br>📧 contacto@jeffacademy.pe<br>O escríbenos por <a href="https://wa.me/51999999999" target="_blank" class="text-success"><b>WhatsApp</b></a> 💬`;
        }
